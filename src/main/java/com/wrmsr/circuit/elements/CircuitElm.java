...
import com.wrmsr.circuit.Editable;
        ...
        implements Editable
{
    ...
    public boolean isCenteredText() { return false; }
    ...
    public boolean canViewInScope() { return getPostCount() <= 2; }
    ...
    public boolean isGraphicElmt() { return false; }
}
