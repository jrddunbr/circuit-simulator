        ...
        extends ChipElm
{
    ...
    public TimerElm(int f, StringTokenizer st)
    {
        super(f, st);
    }

    public int getDefaultFlags() { return FLAG_RESET; }

    public String getChipName() { return "555 Timer"; }
    ...
    public boolean hasReset() { return (flags & FLAG_RESET) != 0; }
    ...
    public int getPostCount() { return hasReset() ? 7 : 6; }

    public int getVoltageSourceCount() { return 1; }

    public int getDumpType() { return 165; }
}
