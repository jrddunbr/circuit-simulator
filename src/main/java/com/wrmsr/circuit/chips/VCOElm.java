        ...
        extends ChipElm
{
    ...
    public VCOElm(int f, StringTokenizer st)
    {
        super(f, st);
    }

    public String getChipName() { return "VCO"; }
    ...
    public int getPostCount() { return 6; }

    public int getVoltageSourceCount() { return 3; }

    public int getDumpType() { return 158; }
}
